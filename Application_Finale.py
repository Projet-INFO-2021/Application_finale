...
explication=Label(fenetre, text='Veuillez séléctionner vos 3 fichiers CSV et votre dossier principal',height=5,width=50,font=('Candara Light',13,'underline'),bg='white')
...
ouvrir1 = Button(fenetre, text="Ouvrir1", command=openfile1,bg='#ccd8df',font=('Courier','11'),cursor='bottom_side')
...
ouvrir2 = Button(fenetre, text="Ouvrir2", command=openfile2,bg='#ccd8df',font=('Courier','11'),cursor='bottom_side')
...
ouvrir3 = Button(fenetre, text="Ouvrir3", command=openfile3,bg='#ccd8df',font=('Courier','11'),cursor='bottom_side')
...
ouvrir4 = Button(fenetre, text="Ouvrir4", command=openfile4,bg='#ccd8df',font=('Courier','11'),cursor='bottom_side')
ouvrir4.grid(column=3,row=6)

blanc=Label(fenetre,text='                 ',bg='white',height=7,width=8)
blanc.grid(column=1,row=7)

fermer = Button(fenetre, text="Valider", command=fenetre.destroy,activebackground='black',bd=6,bg='#3e484f',height=2,width=13,font=('Courier','13'),cursor='hand1',relief=RIDGE,takefocus='shift-tab',foreground='white')
